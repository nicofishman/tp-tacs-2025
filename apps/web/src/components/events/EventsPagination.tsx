    ...
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 py-8">
      <div className="flex items-center gap-2">
        <button
          ...
          className="rounded px-3 py-1 border border-gray-300 bg-white text-gray-700 hover:bg-gray-100 disabled:opacity-50"
        >
          Anterior
        </button>
        {getPageNumbers().map((p, idx) =>
          p === '...'
            ...
            : <button
                ...
                className={`rounded px-3 py-1 border ${p === page ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-100'} disabled:opacity-50`}
              >
                {p}
              </button>
        )}
      ...
      <div className="flex items-center gap-2">
        <span className="text-gray-600 text-sm">Total: {totalCount} eventos</span>
